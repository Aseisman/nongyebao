<template>
  <div>
    ...
    <div style="display:flex;justify-content: space-around;margin-top: 30px;">
      <div style="width:30%;position:relative;">
        ...
        <div style="position: absolute;top: 50px;left: 60px;">
          ...
          <div style="color: rgba(249,249,249,0.9);font-size: 30px;">{{homeData.total}}</div>
        </div>
      </div>
      <div style="width:30%;position:relative;">
        ...
        <div style="position: absolute;top: 50px;left: 60px;">
          ...
          <div style="color: rgba(249,249,249,0.9);font-size: 30px;">{{homeData.entry}}</div>
        </div>
      </div>
      <div style="width:30%;position:relative;">
    ...
    <div style="margin-top:50px;margin-left:24px;">
      <div
        style="width: 45%;text-align: center;border-radius: 24px;box-shadow: 0px 0px 10px rgb(67, 135, 199, 0.2);border: 1px dashed rgba(249,249,249,0.4);float:left;"
      >
    ...
    <div style="margin-top:50px;margin-left:24px;">
      <div
        style="width: 45%;text-align: center;border-radius: 24px;box-shadow: 0px 0px 10px rgb(67, 135, 199, 0.2);border: 1px dashed rgba(249,249,249,0.4);float:left;margin-left: 35px;"
      >
