      ...
      <el-header height="70px">
        <el-row :gutter="20">
          ...
          <el-col :span="6">
            ...
            >
              <el-image :src="avator" class="avator"></el-image>欢迎您：管理员！
            </div>
          </el-col>
        </el-row>
      </el-header>
...
export default {
  ...
  mounted() {
    const userMesage = localStorage.getItem("userMessage");
    if (userMesage.isSuper == 1) {
      ...
      this.navList = [
        ...
        { name: "/AdminList", navItem: "管理员管理", icon: "el-icon-user" }
          ...
          //功能显示
    this.navList=[{ name: "/Home", navItem: "首页", icon: "el-icon-discount" },
        { name: "/UserList", navItem: "用户管理", icon: "el-icon-service" },
        { name: "Access", navItem: "出入统计", icon: "el-icon-receiving" },];
    }
