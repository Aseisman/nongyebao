  ...
  <div v-loading="loading">
    ...
    <div style="width: 95%;margin-left: 2.5%;margin-top: 30px;border-top: 1px solid #EBEEF5;">
      ...
      >
        ...
        <el-table-column prop="gender" label="性别" width="50" :formatter="formatSex"></el-table-column>
        <el-table-column prop="idCard" label="身份证" width="220"></el-table-column>
        <el-table-column prop="room_number" label="住户房号" width="120" sortable></el-table-column>
        <el-table-column prop="access_number" label="出入次数" width="120" sortable></el-table-column>
        <!-- <el-table-column prop="is_lock" label="状态" width="100" :formatter="formatLock" sortable></el-table-column> -->
        <el-table-column prop="is_prosecutor" label="检察人员" width="140">
          <template slot-scope="scope">
            <el-switch
              ...
              active-value="1"
              inactive-value="0"
              v-model="scope.row.is_prosecutor"
              @change="change(scope.$index,scope.row)"
            ></el-switch>
          </template>
        </el-table-column>
        <el-table-column label="状态" prop="lock" :formatter="formatLock">
          <template slot-scope="scope">
            <!-- <el-button
  ...
  created(){
    ...
    this.$axios.userList(this.requestData).then(res=>{
      if(res.code==200){
        ...
        taht.totalPages=res.data.totalPages;
      }
      that.loading=false;
    })
  }
